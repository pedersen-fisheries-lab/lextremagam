...
Here, we can see that the local maximum is highlighted on the original smooth plot. On the derivative plot, we can see where each segment is, coloured by the CI ribbons.

Now you have an overview of the main functions available for use in the lextremagam package!
