...
```{r}
get_results <- function(peak_test, lextr_me, lextr_gr, gam_params, func_type_p, func_type_np){
  results <- list()
...
e2_lextrema_results_me$feature[which(is.na(e2_lextrema_results_me$lag) &
                                          is.na(e2_lextrema_results_me$lead)&
                                          e2_lextrema_results_me$x_end >0.999999&
                                          e2_lextrema_results_me$x_start<0.0000001&
                                          e2_lextrema_results_me$slope_sign ==0)] <- "notrend"
