...
get_power <- function(peak_test, lextr_me, lextr_gr, func_type, me = TRUE){
  ...
  power <- peak_test_pr
  if(me){
    power <- left_join(power, lextr_me_pr, by=c("scenario_id", "func", "param", "error", "dup"))
  }
...
get_bias <- function(lextr_me, lextr_gr, func_type, me = TRUE){
  ...
  bias <- bias_gr%>%
    left_join( bias_gr_max, by=c("scenario_id", "func", "param", "error", "dup"))
  if(me){
    bias <- bias%>%
      left_join(bias_me, by=c("scenario_id", "func", "param", "error", "dup"))%>%
      left_join(bias_me_max, by=c("scenario_id", "func", "param", "error", "dup"))
  }
