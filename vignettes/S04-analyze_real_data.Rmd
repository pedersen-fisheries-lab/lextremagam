...
b2021_tl <- lextremagam:::peaktest_twolines(x = bishop2021$temperature, 
                                             y = bishop2021$specific_growth_rate)
#lextremagam
b2021_gam <- gam(specific_growth_rate~s(temperature, by=as.factor(species), k=5), method="REML", data=bishop2021)

b2021_lextr <- lextremagam::quantify_lextrema2(mod = b2021_gam, 
                                                 var = "temperature", 
                                                 step_size=0.015,
                                                 conf_level = 0.95, 
                                                 deriv_method = "gratia")

b2021_lextr_plot <- plot_lextrema(quant_segments = b2021_lextr, plot_deriv = TRUE)
