...
# EPR ####
  ...
  lextr_epr_tons <- lextremagam::quantify_lextrema_multivar(mod = mod_epr_tons, var = "temp", smooth ="s(temp)", conf_level = 0.95, deriv_method = "gratia", frequentist = FALSE )
  plot_lextrema(quant_segments = lextr_epr_tons, plot_deriv = TRUE, show_segs = "local_max")
  ## hudsonica ####


unique(Sasaki2024_comb_d$metric)
