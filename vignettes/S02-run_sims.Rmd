...
start_e3 <- Sys.time()
sim_e3_results <- list()
sim_e3_results$var-p-location <- run_analyses(sim_data = filter(sim_dat_e3, func=="var-p-location"), logname = "sim_dat_e3_var-p-location_log")
sim_e3_results$var-p-skew <- run_analyses(sim_data = filter(sim_dat_e3, func=="var-p-skew"), logname = "sim_dat_e3_var-p-skew_log")
sim_e3_results$var-p-width <- run_analyses(sim_data = filter(sim_dat_e3, func=="var-p-width"), logname = "sim_dat_e3_var-p-width_log")
...
sim_e3_results_m$lextrema_results_me <- rbind(sim_e3_results$var-p-location$lextrema_results_me, 
                                              sim_e3_results$var-p-skew$lextrema_results_me,
                                              sim_e3_results$var-p-width$lextrema_results_me)
sim_e3_results_m$lextrema_results_gr <- rbind(sim_e3_results$var-p-location$lextrema_results_gr, 
                                              sim_e3_results$var-p-skew$lextrema_results_gr,
                                              sim_e3_results$var-p-width$lextrema_results_gr)
sim_e3_results_m$gam_params <- rbind(sim_e3_results$var-p-location$gam_params, 
                                     sim_e3_results$var-p-skew$gam_params,
                                     sim_e3_results$var-p-width$gam_params)
sim_e3_results_m$peaktest_results <- rbind(sim_e3_results$var-p-location$peaktest_results, 
                                           sim_e3_results$var-p-skew$peaktest_results,
                                           sim_e3_results$var-p-width$peaktest_results)
